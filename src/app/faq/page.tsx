...
const FAQ_GROUPS: { heading: string; items: { q: string; a: string }[] }[] = [
  {
    ...
    items: [
      ...
      { q: "How long does it take to get parts?", a: "FDM: 2–4 business days. SLA: 2–4 days. SLS/MJF: 3–5 days. 5-Axis CNC: 5–7 days. DMLS metal 3D print: 5–10 days. Add 1–2 days for post-processing (anodize, powder coat, vapor smooth). Rush and weekend production available for +15–50% surcharge." },
