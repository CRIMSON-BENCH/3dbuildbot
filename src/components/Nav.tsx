...
const nav = {
  ...
  Resources: [
    ...
    { label: "Blog", href: "/blog", desc: "Manufacturing + engineering insights" },
    { label: "Engineering puzzles", href: "/puzzles", desc: "50 DFM + physics challenges" },
    { label: "International shipping", href: "/international", desc: "500+ cities, 40 countries" },
    ...
    <header className="sticky top-0 z-50 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-2">
          <Link href="/search" aria-label="Search" className="hidden sm:inline-flex p-2 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300">
            <svg width="18" height="18" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="9" cy="9" r="6" /><path d="M14 14l4 4" /></svg>
          </Link>
          <ThemeToggle />
