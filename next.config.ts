...
const securityHeaders = [
  ...
  { key: "X-DNS-Prefetch-Control", value: "on" },
  {
    ...
    value: [
      "default-src 'self'",
      // Clerk needs script access from its custom domain + telemetry + Cloudflare Turnstile (CAPTCHA)
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://vercel.live https://js.stripe.com https://clerk.3dbuildbot.com https://*.clerk.accounts.dev https://*.clerk.com https://challenges.cloudflare.com",
      "style-src 'self' 'unsafe-inline' https://clerk.3dbuildbot.com https://*.clerk.accounts.dev https://*.clerk.com",
      "img-src 'self' data: blob: https:",
      "font-src 'self' data: https://clerk.3dbuildbot.com https://*.clerk.com",
      "connect-src 'self' https://va.vercel-scripts.com https://vitals.vercel-insights.com https://api.stripe.com https://generativelanguage.googleapis.com wss://vercel.live https://clerk.3dbuildbot.com https://*.clerk.accounts.dev https://*.clerk.com https://*.clerk.services",
      "frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://clerk.3dbuildbot.com https://*.clerk.accounts.dev https://*.clerk.com https://challenges.cloudflare.com",
      "worker-src 'self' blob:",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self' https://clerk.3dbuildbot.com",
